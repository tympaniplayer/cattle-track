...
namespace CattleTrack.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CattleTrackDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CattleTrackEfCoreEntityExtensionMappings to extend the IdentityUser entity
